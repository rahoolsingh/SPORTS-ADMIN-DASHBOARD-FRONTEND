...
function CoachTable({ coachData, setCoachData }) {
    ...
    return (
        <div className="w-full p-4">
            ...
            {
                // Show status message if there is no data
                coachData.length === 0 && (
    ...
    return (
        ...
        `}
            ...
            <div className="col-span-1 flex items-center justify-center md:justify-end">
                {Data.status === "pending" && (
                    <>
                        <button
                            ...
                            className="bg-green-600 text-white px-3 py-1 rounded-b-lg hover:bg-green-800 font-medium"
                        >
                        ...
                        <button
                            ...
                            className="bg-red-600 text-white px-3 py-1 rounded-b-lg hover:bg-red-800 ml-2"
                        >
                ...
                <a
                    href={`edit-coach/${Data.regNo}`}
                    target="_blank"
                    className="bg-blue-600 text-white px-3 py-1 rounded-b-lg hover:bg-blue-800 ml-2"
                >
